...
class LcdcharThread(JNTBusThread):
    """The basic thread
    ...
    def init_bus(self):
        """Build the bus
        """
        from janitoo_raspberry_lcdchar.bus_lcdchar import LcdcharBus
        self.section = OID
        self.bus = LcdcharBus(options=self.options, oid=self.section, product_name="Raspberry LCDChar")
